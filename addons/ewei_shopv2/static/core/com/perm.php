...
class Perm_EweiShopV2ComModel extends ComModel
{
	...
	protected function perm_store()
	{
		$perm = array(
			...
			'verifygoods' => array('text' => '核销商品核销管理', 'edit' => '修改-log', 'view' => '查看', 'deletelog' => '删除核销记录'),
			'verifylog'   => array('text' => '核销商品统计', 'main' => '查看列表')
			);
