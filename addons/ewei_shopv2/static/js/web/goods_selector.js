    ...
    function (biz) {
        ...
        model.open = function (callback, type, merchid, multi, api_url, selected_ids,no_merchid,platform){
            ...
            if (typeof(model.callback) == 'string'){
                ...
                $.ajax({
                    url: url, async: false, success: function (htm) {
        ...
        model.put = function (id) {
            ...
            var url = "./index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=util.goods_selector.op&id=" + id + "&column=" + encodeURI($("#goods-selected-list-" + model.name).attr("data-column"));
