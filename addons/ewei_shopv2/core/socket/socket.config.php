...
// 设置SSL KEY文件路径
define('SOCKET_SERVER_SSL_KEY_FILE', '/etc/letsencrypt/live/mb.sstjkkj.com/privkey.pem');

// 设置SSL CERT文件路径
define('SOCKET_SERVER_SSL_CERT_FILE', '/etc/letsencrypt/live/mb.sstjkkj.com/fullchain.pem');
