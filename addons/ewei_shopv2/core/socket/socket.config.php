...
// 设置SSL KEY文件路径
define('SOCKET_SERVER_SSL_KEY_FILE', '/var/www/html/Nginx/2_mb.sstjkkj.com.key');

// 设置SSL CERT文件路径
define('SOCKET_SERVER_SSL_CERT_FILE', '/var/www/html/Nginx/1_mb.sstjkkj.com_bundle.crt');
