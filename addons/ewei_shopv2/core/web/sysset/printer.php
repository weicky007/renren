    ...
    protected function printer_post()
    {
        ...
        if ($_W['ispost']) {
            ...
            $data['print_data'] = json_encode(array(
                ...
                'printer_feie_new'=>is_array($_GPC['printer_feie_new']) ? $_GPC['printer_feie_new'] : array(),
                'printer_yilianyun_auth2'=>is_array($_GPC['printer_yilianyun_auth2']) ? $_GPC['printer_yilianyun_auth2'] : array()
            ));
            ...
            if($data['type'] == 6){
                ...
                if($res['error']) show_json(0, $res['error_description']);
            }
            if (empty($id)) {
                $data['createtime'] = time();
