...
class Create_EweiShopV2Page extends MobileLoginPage
{
    ...
    public function main()
    {
        ...
        if (!$packageid) {
            ...
            if (empty($id)) {
                if (!empty($quickid)) {
                    $sql = "SELECT c.goodsid,c.total,g.maxbuy,g.type,g.intervalfloor,g.intervalprice,g.issendfree,g.isnodiscount,g.ispresell,g.presellprice as gpprice,o.presellprice,g.preselltimeend,g.presellsendstatrttime,g.presellsendtime,g.presellsendtype" . ",g.weight,o.weight as optionweight,g.title,g.thumb,ifnull(o.marketprice, g.marketprice) as marketprice,o.title as optiontitle,c.optionid," . " g.storeids,g.isverify,g.isforceverifystore,g.deduct,g.manydeduct,g.manydeduct2,g.virtual,o.virtual as optionvirtual,discounts," . " g.deduct2,g.ednum,g.edmoney,g.edareas,g.edareas_code,g.diyformtype,g.diyformid,diymode,g.dispatchtype,g.dispatchid,g.dispatchprice,g.minbuy " . " ,g.isdiscount,g.isdiscount_time,g.isdiscount_time_start,g.isdiscount_discounts,g.cates,g.isfullback, " . " g.virtualsend,invoice,o.specs,g.merchid,g.checked,g.merchsale,g.unite_total," . " g.buyagain,g.buyagain_islong,g.buyagain_condition, g.buyagain_sale, g.hasoption, g.threen" . " FROM " . tablename("ewei_shop_quick_cart") . " c " . " left join " . tablename("ewei_shop_goods") . " g on c.goodsid = g.id " . " left join " . tablename("ewei_shop_goods_option") . " o on c.optionid = o.id " . " where c.openid=:openid and c.selected=1 and  c.deleted=0 and c.uniacid=:uniacid and c.quickid=" . $quickid . "  order by c.id desc";
                    $goods = pdo_fetchall($sql, array(":uniacid" => $uniacid, ":openid" => $openid));
                } else {
                    if (empty($exchangeOrder)) {
                        $sql = "SELECT c.goodsid,c.total,g.maxbuy,g.type,g.intervalfloor,g.intervalprice,g.issendfree,g.isnodiscount,g.ispresell,g.presellprice as gpprice,o.presellprice,g.preselltimeend,g.presellsendstatrttime,g.presellsendtime,g.presellsendtype" . ",g.weight,o.weight as optionweight,g.title,g.thumb,ifnull(o.marketprice, g.marketprice) as marketprice,o.title as optiontitle,c.optionid," . " g.storeids,g.isverify,g.isforceverifystore,g.deduct,g.manydeduct,g.manydeduct2,g.virtual,o.virtual as optionvirtual,discounts," . " g.deduct2,g.ednum,g.edmoney,g.edareas,g.edareas_code,g.diyformtype,g.diyformid,diymode,g.dispatchtype,g.dispatchid,g.dispatchprice,g.minbuy " . " ,g.isdiscount,g.isdiscount_time,g.isdiscount_time_start,g.isdiscount_discounts,g.cates, " . " g.virtualsend,invoice,o.specs,g.merchid,g.checked,g.merchsale," . " g.buyagain,g.buyagain_islong,g.buyagain_condition, g.buyagain_sale, g.hasoption" . " FROM " . tablename("ewei_shop_member_cart") . " c " . " left join " . tablename("ewei_shop_goods") . " g on c.goodsid = g.id " . " left join " . tablename("ewei_shop_goods_option") . " o on c.optionid = o.id " . " where c.openid=:openid and c.selected=1 and  c.deleted=0 and c.uniacid=:uniacid  order by c.id desc";
                        $goods = pdo_fetchall($sql, array(":uniacid" => $uniacid, ":openid" => $openid));
                    } else {
                        if (p("exchange")) {
                            $sql = "SELECT c.goodsid,c.total,g.maxbuy,g.type,g.intervalfloor,g.intervalprice,g.issendfree,g.isnodiscount,g.ispresell,g.presellprice as gpprice,o.presellprice,g.preselltimeend,g.presellsendstatrttime,g.presellsendtime,g.presellsendtype" . ",g.weight,o.weight as optionweight,g.title,g.thumb,ifnull(o.marketprice, g.marketprice) as marketprice,o.title as optiontitle,c.optionid," . " g.storeids,g.isverify,g.isforceverifystore,g.deduct,g.manydeduct,g.manydeduct2,g.virtual,o.virtual as optionvirtual,discounts," . " g.deduct2,g.ednum,g.edmoney,g.edareas,g.edareas_code,g.diyformtype,g.diyformid,diymode,g.dispatchtype,g.dispatchid,g.dispatchprice,g.minbuy " . " ,g.isdiscount,g.isdiscount_time,g.isdiscount_time_start,g.isdiscount_discounts,g.cates,g.isfullback, " . " g.virtualsend,invoice,o.specs,g.merchid,g.checked,g.merchsale,g.unite_total," . " g.buyagain,g.buyagain_islong,g.buyagain_condition, g.buyagain_sale, g.hasoption" . " FROM " . tablename("ewei_shop_exchange_cart") . " c " . " left join " . tablename("ewei_shop_goods") . " g on c.goodsid = g.id " . " left join " . tablename("ewei_shop_goods_option") . " o on c.optionid = o.id " . " where c.openid=:openid and c.selected=1 and  c.deleted=0 and c.uniacid=:uniacid  order by c.id desc";
                            $goods = pdo_fetchall($sql, array(":uniacid" => $uniacid, ":openid" => $openid));
                        }
                    }
                }
                ...
                if (!empty($id) && !empty($iswholesale)) {
                        ...
                        if (0 < $option["optionid"]) {
                            ...
                            if (!empty($option)) {
                                ...
                                if (empty($data["unite_total"])) {
                                    ...
                                    if ($option["stock"] < $num && -1 < $option["stock"]) {
                    ...
                    $sql = "SELECT id as goodsid,type,title,weight,issendfree,isnodiscount,ispresell,presellprice," . " thumb,marketprice,liveprice,islive,storeids,isverify,isforceverifystore,deduct,hasoption,preselltimeend,presellsendstatrttime,presellsendtime,presellsendtype," . " manydeduct,manydeduct2,`virtual`,maxbuy,usermaxbuy,discounts,total as stock,deduct2,showlevels," . " ednum,edmoney,edareas,edareas_code,unite_total,diyfields," . " diyformtype,diyformid,diymode,dispatchtype,dispatchid,dispatchprice,cates,minbuy, " . " isdiscount,isdiscount_time,isdiscount_time_start,isdiscount_discounts,isfullback, " . " virtualsend,invoice,needfollow,followtip,followurl,merchid,checked,merchsale, " . " buyagain,buyagain_islong,buyagain_condition, buyagain_sale,bargain" . $threensql . $ishotelsql . " FROM " . tablename("ewei_shop_goods") . " where id=:id and uniacid=:uniacid  limit 1";
                    $data = pdo_fetch($sql, array(":uniacid" => $uniacid, ":id" => $id));
                ...
                if (!($g["seckillinfo"] && $g["seckillinfo"]["status"] == 0)) {
                    if (empty($bargain_id)) {
                        ...
                        if ($prices["discounttype"] == 1) {
                            ...
                            if ($prices["discounttype"] == 2 && empty($bargain_id)) {
    ...
    public function submit()
    {
        ...
        $grprice = $totalprice;
        isset($_SESSION["exchangeprice"]) and isset($_SESSION["exchangeprice"]) && ($grprice = $_SESSION["exchangeprice"]);
        ...
        if (!empty($card_data) && ($card_data["discount"] == 0 || $card_data["discount_rate"] <= 0)) {
            $totalprice = $totalprice + $isdiscountprice;
            $isdiscountprice = 0;
        }
        if (empty($package) && $is_openmerch == 1) {
            foreach ($merch_array as $key => $value) {
                if (0 < $key) {
                    $merch_array[$key]["set"] = $merch_plugin->getSet("sale", $key);
                    if (!$packageid) {
        ...
        foreach ($allgoods as &$g) {
            ...
            if (!empty($_GPC["deduct2"]) && !empty($saleset["moneydeduct"]) && !empty($g["need_deduct2"])) {
                ...
                $goods_need_deduct2 = price_format(floor($g["need_deduct2"] * 100) / 100);
        ...
        if (!empty($return_card_array)) {
            ...
            $deductprice2 = $return_card_array["deductcredit2"];
        }
    ...
    public function caculatecard($card_id, $dispatch_price, $lotterydiscountprice, $taskcut, $goodsarr, $totalprice, $discountprice, $isdiscountprice, $liveid, $isSubmit = 0, $goods_dispatch = array())
    {
        global $_W;
        $open_redis = function_exists("redis") && !is_error(redis());
        $openid = $_W["openid"];
        ...
        if (is_array($goodsarr)) {
            ...
            foreach ($goodsarr as $k => &$g) {
                ...
                if ($g["status"] != 2) {
                    ...
                    if ($g["discounttype"] == 2) {
                        if (0 < $data["discount"]) {
                            if (0 < $discount_rate && ($cardmodel == 1 || $cardmodel == 2 && in_array($g["goodsid"], $allowgoodslist))) {
                        ...
                        if ($g["discounttype"] == 1) {
                            if (0 < $data["discount"] && ($cardmodel == 1 || $cardmodel == 2 && in_array($g["goodsid"], $allowgoodslist))) {
                                if (0 < $discount_rate) {
        ...
        if (!empty($saleset)) {
            ...
            if (!empty($saleset["creditdeduct"])) {
                ...
                if ($totalprice - $isdiscountprice - $deductenough_money < $deductmoney) {
            ...
            if (!empty($saleset["moneydeduct"])) {
                $deductcredit2 = $member["credit2"];
                if ($totalprice - $isdiscountprice - $deductenough_money + $dispatch_price < $deductcredit2) {
