	...
	public function perm_openfarm()
	{
		return $this->isopen('open_farm') && $this->is_perm_plugin('open_farm') ? array(
			...
			'notice'    => array(
				...
				'getInfo'    => '修改',
				'deleteInfo' => '删除',
				'xxx'        => array('getList' => 'main', 'deleteAll' => 'deleteInfo')
			),
			'reply'     => array(
				'text'       => '回复管理',
				'main'       => '回复列表',
			...
			'mood'      => array(
				...
				'main'    => '查看',
				'addInfo' => '添加',
				'xxx'     => array('getInfo' => 'main', 'getSon' => 'addInfo', 'addMood' => 'addInfo', 'addMoodPicture' => 'addInfo')
			),
			'task'      => array(
				'text'       => '任务管理',
				'main'       => '任务列表',
				...
				'editInfo'   => '修改',
				'deleteInfo' => '删除',
				'xxx'        => array('getList' => 'main', 'getInfo' => 'editInfo', 'getCategory' => 'editInfo', 'getMemberLevel' => 'editInfo', 'getTaskCore' => 'editInfo', 'getGoods' => 'editInfo')
			),
			'grade'     => array(
				'text'       => '等级管理',
				'main'       => '等级列表',
			...
			'surprised' => array(
				...
				'getInfo'    => '修改',
				'deleteInfo' => '删除',
				'xxx'        => array('getList' => 'main', 'deleteAll' => 'deleteInfo', 'getCoupon' => 'getInfo', 'getCategory' => 'getInfo')
			),
			'seting'    => array(
				'text'     => '农场设置',
				'main'     => '查看',
				'editInfo' => '修改',
				'xxx'      => array('getInfo' => 'main', 'getAdvertisementMax' => 'editInfo')
			),
			'configure' => array(
				'text'     => '农场配置',
				'main'     => '查看',
				'editInfo' => '修改',
				'xxx'      => array('getInfo' => 'main', 'getAdvertisementMax' => 'editInfo', 'setReplyKeywordRule' => 'editInfo', 'getRule' => 'editInfo', 'setReply' => 'editInfo', 'setKeyword' => 'editInfo')
			)
		) : array();
	}
