...
class Wxcard_EweiShopV2ComModel extends ComModel {
    ...
    public function verifygoodcard($carddata,$card_id="") {
        ...
        $params = array(
            ...
            "auto_activate"=>"false",                   
            "wx_activate"=>"false",                    
            "activate_url"=>mobileUrl('verifygoods/activecard','',true)
        ,"use_limit"=>1000
        ,"get_limit"=>1000
        );
    ...
    public function membercardmanager($carddata,$card_id="") {
        ...
        $params = array(
            ...
            "supply_bonus"=>"true",               
            "bonus_url"=>mobileUrl('member',null,true), 
            "supply_balance"=>empty($carddata['card_supply_balance'])?"false":"true",                
            "balance_url"=>mobileUrl('member',null,true), 

            "auto_activate"=>"false",                   
            "wx_activate"=>"false",                     
            "activate_url"=>mobileUrl('member/activation',null,true)
        );
