...
class MemberController extends PluginMobilePage
{
    ...
    public function getMemberCard()
    {
        ...
        unset($value);
        $results_my = p("membercard")->get_Mycard("", 0, 10, "all");
    ...
    public function cart()
    {
        ...
        $site = $_W["siteroot"];
        $_W["siteroot"] = $this->model->set["mobile_domain"];
    ...
    protected function getWapSet()
    {
        ...
        $set["wap"]["loginurl"] = pcUrl("pc/member/login", $params);
        $set["wap"]["regurl"] = pcUrl("pc/member/register", $params);
        $set["wap"]["forgeturl"] = pcUrl("pc/member/forget", $params);
        return $set;
    }
}
