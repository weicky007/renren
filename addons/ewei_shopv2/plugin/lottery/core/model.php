...
class LotteryModel extends PluginModel 
{
	...
	public function getLotteryList($openid, $param = array()) 
	{
		...
		if (!(empty($lottery_list))) 
		{
			...
			$remark = "\n" . '<a href=\'' . $url . '\'>点击去抽奖</a>';
			$text = '恭喜您获得抽奖机会 ' . "\n" . $remark;
			$message = array( 'first' => array('value' => '恭喜您获得抽奖机会', 'color' => '#000000'), 'keyword1' => array('value' => $lottery_list['title'], 'color' => '#000000'), 'keyword2' => array('value' => '获得抽奖机会', 'color' => '#000000'), 'remark' => array('value' => '恭喜您获得抽奖机会！！', 'color' => '#000000') );
