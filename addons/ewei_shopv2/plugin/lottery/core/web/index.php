...
class Index_EweiShopV2Page extends PluginWebPage {
    ...
    protected function post() {
        ...
        if ($_W['ispost']) {
            ...
            }elseif ((intval($_GPC['lottery_type']) == 1 && $itemCount < 5) && !empty($itemCount)){
            ...
            $data['lottery_cannot'] = trim(str_replace(array("\r", "\n", "\r\n"), "", $_GPC['lottery_cannot']));
    ...
    function taskTypeIsExist($task_type, $id) {
        global $_W;
