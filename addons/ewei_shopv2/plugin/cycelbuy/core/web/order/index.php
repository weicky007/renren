    ...
    protected function selectOrderPrice($day = 0)
    {
        ...
        if( $day != 0 ) 
        {
            if( $day == 30 ) 
            {
                ...
                $year = date("Y");
                $month = date("m");
                $createtime1 = strtotime((string) $year . "-" . $month . "-1 00:00:00");
                $createtime2 = strtotime((string) $year . "-" . $month . "-" . $d . " 23:59:59");
            }
            else
            {
                if( $day == 7 ) 
