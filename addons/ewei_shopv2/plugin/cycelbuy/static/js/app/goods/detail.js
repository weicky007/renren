define(['core', 'tpl', './picker.js', 'biz/member/favorite', 'biz/member/cart', 'biz/plugin/diyform', 'biz/sale/coupon/couponpicker', 'biz/goods/wholesalePicker'], function (core, tpl, picker, favorite, cart, diyform, couponpicker, wholesalePicker) {
    var modal = {};
                        ...
                        if ($('.diyform-container').length > 0) {
                            ...
                            if (!diyformdata) {
                                ...
                                core.json('order/create/diyform', {
                                    ...
                                    $.router.load(core.getUrl('cycelbuy/order/create', {
                                        id: modal.goodsid,
                                        optionid: modal.optionid,
                                        total: modal.total,
