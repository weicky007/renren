	...
	protected function post() {
		...
		if ($_W['ispost']) {
			...
			$data = array(
				...
				, "article_content" => m('common')->html_images($_GPC['editor'],true)
				...
				, "article_rule_daynum" => trim($_GPC['article_rule_daynum'])
				, "article_rule_allnum" => trim($_GPC['article_rule_allnum'])
				, "article_rule_credit" => intval($_GPC['article_rule_credit'])
				, "article_rule_money" => trim($_GPC['article_rule_money'])
				, "page_set_option_nocopy" => intval($_GPC['page_set_option_nocopy'])
				, "page_set_option_noshare_tl" => intval($_GPC['page_set_option_noshare_tl'])
				, "page_set_option_noshare_msg" => intval($_GPC['page_set_option_noshare_msg'])
				, "article_keyword2" => trim($_GPC['article_keyword2'])
				, "article_report" => intval($_GPC['article_report'])
				, "product_advs_type" => intval($_GPC['product_advs_type'])
				, "product_advs_title" => trim($_GPC['product_advs_title'])
				, "product_advs_more" => trim($_GPC['product_advs_more'])
				, "product_advs_link" => trim($_GPC['product_advs_link'])
				, "article_state" => intval($_GPC['article_state'])
				, "uniacid" => $_W['uniacid']
				, "article_rule_credittotal" => intval($_GPC['article_rule_credittotal'])
				, "article_rule_moneytotal" => trim($_GPC['article_rule_moneytotal'])
				, "article_rule_credit2" => intval($_GPC['article_rule_credit2'])
				, "article_rule_money2" => trim($_GPC['article_rule_money2'])
				, "article_rule_creditm" => intval($_GPC['article_rule_creditm'])
				, "article_rule_moneym" => trim($_GPC['article_rule_moneym'])
				, "article_rule_creditm2" => intval($_GPC['article_rule_creditm2'])
				, "article_rule_moneym2" => trim($_GPC['article_rule_moneym2'])
				, "article_readtime" => trim($_GPC['article_readtime'])
				, "article_areas" => trim($_GPC['article_areas'])
				, "article_endtime" => strtotime($_GPC['article_endtime'])
				, "article_hasendtime" => intval($_GPC['article_hasendtime'])
				, "displayorder" => intval($_GPC['displayorder'])
				, "article_advance" => intval($_GPC['article_advance'])
				, "article_virtualadd" => intval($_GPC['article_virtualadd'])
				, "article_visit" => intval($_GPC['article_visit'])
				, "article_visit_level" => iserializer($_GPC['article_visit_level'])
				, "article_visit_tip" => iserializer($_GPC['article_visit_tip'])
			);
            ...
            if(!empty($data['article_keyword2'])){
                ...
                if(!empty($rule)){
                    ...
                    $keyword_data = array(
                        ...
                        'rid' => $rid,
                        'module' => 'ewei_shopv2',
                        'content' => trim($data['article_keyword2']),
                        'type' => 1,
                        'displayorder' => 0,
                        'status' => 1
                    );
