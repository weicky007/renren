...
class MerchModel extends PluginModel
{
    ...
    public function getGoodsTotals()
    {
        global $_W;
        return array(
            "sale" => pdo_fetchcolumn('select count(1) from ' . tablename('ewei_shop_goods') . " where checked=0 and status=1 and deleted=0 and total>0 and uniacid=:uniacid and merchid=:merchid", array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid'])),
            "out" => pdo_fetchcolumn('select count(1) from ' . tablename('ewei_shop_goods') . " where checked=0 and  status=1 and deleted=0 and total=0 and uniacid=:uniacid and merchid=:merchid", array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid'])),
            "check" => pdo_fetchcolumn('select count(1) from ' . tablename('ewei_shop_goods') . " where checked=1 and deleted=0 and uniacid=:uniacid and merchid=:merchid", array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid'])),
            "stock" => pdo_fetchcolumn('select count(1) from ' . tablename('ewei_shop_goods') . " where checked=0 and status=0 and deleted=0 and uniacid=:uniacid  and merchid=:merchid", array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid'])),
            "cycle" => pdo_fetchcolumn('select count(1) from ' . tablename('ewei_shop_goods') . " where deleted=1 and uniacid=:uniacid and merchid=:merchid", array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid'])),
        );
    }
    ...
    function getOrderTotals()
    {
        ...
        $totals['all'] = pdo_fetchcolumn(
            ...
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and deleted=0", $paras);
        $totals['status_1'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_order') . ""
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and status=-1 and refundtime=0 and deleted=0", $paras);
        $totals['status0'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_order') . ""
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and status=0 and paytype<>3 and deleted=0", $paras);
        $totals['status1'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_order') . ""
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and ( status=1 or ( status=0 and paytype=3) ) and deleted=0", $paras);
        $totals['status2'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_order') . ""
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and status=2 and deleted=0", $paras);
        $totals['status3'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_order') . ""
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and status=3 and deleted=0", $paras);
        $totals['status4'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_order') . ""
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and refundstate>0 and refundid<>0 and deleted=0", $paras);
        $totals['status5'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_order') . ""
            . " WHERE uniacid = :uniacid {$condition} and merchid = :merchid and refundtime<>0 and deleted=0", $paras);
        return $totals;
    }

    function getListUser($list, $return = 'all')
    {
        global $_W;
        if (!is_array($list)) {
    ...
    function getListUserOne($merchid)
    {
        global $_W;
    ...
    private function check($permtype = '')
    {
        ...
        $user = pdo_fetch('select u.status as userstatus,r.status as rolestatus,r.perms as roleperms,u.roleid from ' . tablename('ewei_shop_merch_account') . ' u '
            . ' left join ' . tablename('ewei_shop_merch_perm_role') . ' r on u.roleid = r.id '
            . ' where u.id=:merchuid limit 1 ', array(':merchuid' => $uid));
    ...
    public function getUserTotals()
    {
        ...
        $totals = array(
            'reg0' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_reg') . ' where uniacid=:uniacid and status=0 limit 1', array(':uniacid' => $_W['uniacid'])),
            'reg_1' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_reg') . ' where uniacid=:uniacid and status=-1 limit 1', array(':uniacid' => $_W['uniacid'])),
            'user0' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_user') . ' where uniacid=:uniacid and status=0 limit 1', array(':uniacid' => $_W['uniacid'])),
            'user1' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_user') . ' where uniacid=:uniacid and status=1 limit 1', array(':uniacid' => $_W['uniacid'])),
            'user2' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_user') . ' where uniacid=:uniacid and status=2 limit 1', array(':uniacid' => $_W['uniacid'])),
            'user3' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_user') . ' where uniacid=:uniacid and status=1 and TIMESTAMPDIFF(DAY,now(),FROM_UNIXTIME(accounttime))<=30  limit 1', array(':uniacid' => $_W['uniacid'])),
        );
        return $totals;
    }
    ...
    public function getClearTotals()
    {
        ...
        $totals = array(
            'status0' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_clearing') . ' where uniacid=:uniacid and status=0 limit 1', array(':uniacid' => $_W['uniacid'])),
            'status1' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_clearing') . ' where uniacid=:uniacid and status=1 limit 1', array(':uniacid' => $_W['uniacid'])),
            'status2' => pdo_fetchcolumn('select count(*) from ' . tablename('ewei_shop_merch_clearing') . ' where uniacid=:uniacid and status=2 limit 1', array(':uniacid' => $_W['uniacid'])),
        );
        return $totals;
    }
    ...
    public function getMerchOrderTotals($type = 0)
    {
        ...
        $sql = "select sum(o.price) as totalmoney from " . tablename('ewei_shop_order') . ' o '
            . " left join " . tablename('ewei_shop_merch_user') . " u on u.id = o.merchid "
            . " where 1 {$condition} ";

        $price = pdo_fetch($sql, $params);
        $totalmoney = round($price['totalmoney'], 2);

        $sql = "select count(o.id) as totalcount from " . tablename('ewei_shop_order') . ' o '
            . " left join " . tablename('ewei_shop_merch_user') . " u on u.id = o.merchid "
            . " where 1 {$condition} ";
    ...
    public function sendMessage($sendData, $message_type)
    {
        ...
        if ($message_type == 'merch_apply' && empty($usernotice['merch_apply'])) {
            if ($tm['is_advanced']) {
                ...
                $message = array(
                    'keyword1' => !empty($tm['merch_applytitle']) ? $tm['merch_applytitle'] : '商户入驻申请',
                    'keyword2' => !empty($tm['merch_apply']) ? $tm['merch_apply'] : '[商户名称]在[申请时间]提交了入驻申请，请到后台查看~'
                );
        ...
        if ($message_type == 'merch_apply_money' && empty($usernotice['merch_apply_money'])) {
            if ($tm['is_advanced']) {
                ...
                $message = array(
                    'keyword1' => !empty($tm['merch_applymoneytitle']) ? $tm['merch_applymoneytitle'] : '商户提现申请',
                    'keyword2' => !empty($tm['merch_applymoney']) ? $tm['merch_applymoney'] : '[商户名称]在[申请时间]提交了提现申请,提现金额' . $sendData['money'] . '.[联系人] [手机号].请到后台查看~'
                );
    ...
    public function getMerchOrderTotalPrice($merchid)
    {
        ...
        $sql = "select *  from " . tablename('ewei_shop_merch_bill')
            . " where 1 {$condition} and status=1 and creditstatus =2";
        ...
        $sql = "select * from " . tablename('ewei_shop_merch_bill')
            . " where 1 {$condition} and status=2 and creditstatus =2";
        ...
        $sql = "select *  from " . tablename('ewei_shop_merch_bill')
            . " where 1 {$condition} and status=3 and creditstatus =2";
    ...
    public function getMerchPrice($merchid, $flag = 0)
    {
        ...
        if ($refunddays > 0) {
            ...
            $conditionrefund .= ' and r.operatetime<:operatetime and o.status = 3';
            $params[':finishtime'] = $finishtime;
            $paramsrefund[':operatetime'] = $finishtime;
        }
        $orderids = array();
        $sql = "select {$con} from " . tablename('ewei_shop_merch_user') . " u "
            . " left join " . tablename('ewei_shop_order') . " o on u.id=o.merchid"
            . " where 1 {$condition} limit 1";
        $list = pdo_fetch($sql, $params);

        $merchcouponprice = pdo_fetchcolumn("select sum(o.couponprice) from " . tablename('ewei_shop_merch_user') . " u "
            . " left join " . tablename('ewei_shop_order') . " o on u.id=o.merchid"
            . " where o.couponmerchid>0 {$condition} limit 1", $params);

        $refundlist = pdo_fetchall("select o.id,r.orderprice,r.applyprice from " . tablename('ewei_shop_merch_user') . " u "
            . " left join " . tablename('ewei_shop_order') . " o on u.id=o.merchid"
            . " left join " . tablename('ewei_shop_order_refund') . " r on o.refundid=r.id"
            . " where o.refundid>0 and r.status=1 and o.status = 3 and r.applyprice<r.orderprice  {$conditionrefund} ", $paramsrefund, 'id');
        ...
        {
            $sql = "SELECT 
	o.id,refund.ordergoodsrealprice,refund.applyprice
FROM 
	" . tablename('ewei_shop_order') . " AS o 
	LEFT JOIN " . tablename('ewei_shop_order_single_refund') . " AS refund ON o.id = refund.orderid 
	INNER JOIN " . tablename('ewei_shop_order_goods') . " AS og ON refund.ordergoodsid = og.id 
	AND o.id = og.orderid where o.uniacid = :uniacid and o.merchid = :merchid  and refund.operatetime<:operatetime and o.status = 3 and o.finishtime < :finishtime";
            $result = pdo_fetchall($sql, array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid'], ':operatetime' => $finishtime = intval(time() - $refunddays * 3600 * 24),':finishtime'=>$finishtime));

            foreach ($result as $key => $value) {
                $refundprice += ($value['orderprice'] - $value['applyprice']);
                if (in_array($value['id'], $orderids) === false) {
                    $orderids[] = $value['id'];
                }
                $refundorderprice += $value['orderprice'];
            }
        ...
        if ($flag > 0) {
            $sql = "select o.id,o.agentid,comprice.commission_price,comprice.order_id from " . tablename('ewei_shop_merch_user') . " u "
                . " left join " . tablename('ewei_shop_order') . " o on u.id=o.merchid"
                . " left join " . tablename('ewei_shop_merch_commission_orderprice') . " comprice on o.id=comprice.order_id"
                . " where 1 {$condition}";
    ...
    public function getMerchPriceList($merchid, $orderid = 0, $flag = 0, $applyid = 0, $pindex = 0, $psize = 0)
    {
        ...
        $con = "o.id,u.merchname,u.payrate,o.price,o.goodsprice,o.dispatchprice,discountprice,"
            . "o.deductprice,o.deductcredit2,o.isdiscountprice,o.deductenough,o.changeprice,o.agentid,o.seckilldiscountprice,"
            . "o.merchdeductenough,o.merchisdiscountprice,o.couponmerchid,o.couponprice,o.couponmerchid,o.ordersn,o.finishtime,o.merchapply,"
            . "r.orderprice as rprice,r.applyprice,"
            . "comprice.commission_price,comprice.order_id,r.status as rstatus";
        ...
        foreach ($order as &$list) {
            ...
            $list['realprice'] = $list['orderprice'] - $list['merchdeductenough'] - $list['merchisdiscountprice'] - $merchcouponprice;//提现金额
            ...
            $sql = "SELECT
	og.orderid,refund.applyprice,refund.status as rstatus
FROM
	".tablename('ewei_shop_order_single_refund')." AS refund
	INNER JOIN
	".tablename('ewei_shop_order_goods')." AS og
	ON 
		refund.ordergoodsid = og.id AND
		refund.uniacid = og.uniacid
	INNER JOIN
	".tablename('ewei_shop_order')." AS o
	ON 
		og.orderid = o.id AND
		refund.orderid = o.id AND
		og.uniacid = o.uniacid
        where og.uniacid = :uniacid 
				and refund.status in (0,1,3) and og.orderid = :id";
            $single_refund_price = pdo_fetchall($sql, array(':uniacid' => $_W['uniacid'], ':id' => $list['id']));
        
            foreach ($single_refund_price as $tmp) {
                $list['rstatus'] = $tmp['rstatus'];
                $list['applyprice'] += $tmp['applyprice'];
                if (array_key_exists('applyprice', $list) && $list['applyprice'] > 0 && $list['rstatus'] == 1) {

                    $list['refundprice'] += $tmp['applyprice'];
                    $list['realprice'] -= $tmp['applyprice'];
                } elseif ($list['rstatus'] == -2) {
            ...
            if ($applyid) {
                ...
                if ($item) $list['payrate'] = $item['payrate'];
            }
    ...
    public function getMerchCreditList($merchid, $orderid = 0, $flag = 0, $creditrate = 0, $isbillcredit = 1)
    {
        ...
        $con = 'o.id,u.merchname,u.iscreditmoney,u.creditrate,u.iscreditmoney,dispatch, money, credit,o.logno as ordersn,o.createtime,o.time_finish,o.createtime' .
            ',o.merchapply';

        $sql = "select {$con} from " . tablename('ewei_shop_merch_user') . " u "
            . " left join " . tablename('ewei_shop_creditshop_log') . " o on u.id=o.merchid"
            . " where 1 {$condition}";
        $order = pdo_fetchall($sql, $params);
        $_order = array();
        if (!empty($order)) {
    ...
    public function getMerchCreditTotalPrice($merchid)
    {
        ...
        $sql = "select *  from " . tablename('ewei_shop_merch_bill')
            . " where 1 {$condition} and status=1 and creditstatus = 1";
        $status1 = pdo_fetchall($sql, $params);
        ...
        $sql = "select * from " . tablename('ewei_shop_merch_bill')
            . " where 1 {$condition} and status=2 and creditstatus = 1";
        $status2 = pdo_fetchall($sql, $params);
        ...
        $sql = "select *  from " . tablename('ewei_shop_merch_bill')
            . " where 1 {$condition} and status=3 and creditstatus = 1";
        $status3 = pdo_fetchall($sql, $params);
    ...
    public function getMerchCredit($merchid, $flag = 0)
    {
        ...
        if ($flag > 0) {
            $sql = "select o.id,u.iscreditmoney,o.dispatch,o.money,o.credit from " . tablename('ewei_shop_merch_user') . " u "
                . " left join " . tablename('ewei_shop_creditshop_log') . " o on u.id=o.merchid"
                . " where 1 {$condition}";
            $order = pdo_fetchall($sql, $params);
    ...
    public function getOneApply($id)
    {
        ...
        $sql = "select b.*,u.merchname,u.realname,u.mobile,u.iscreditmoney from " . tablename('ewei_shop_merch_bill') . " b "
            . " left join " . tablename('ewei_shop_merch_user') . " u on b.merchid = u.id"
            . " where 1 {$condition} Limit 1";
    ...
    public function getMerchApplyTotals($merchid = 0)
    {
        ...
        $totals['status1'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_merch_bill')
            . " WHERE 1 {$condition} and status=1", $params);

        $totals['status2'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_merch_bill')
            . " WHERE 1 {$condition} and status=2", $params);

        $totals['status3'] = pdo_fetchcolumn(
            'SELECT COUNT(1) FROM ' . tablename('ewei_shop_merch_bill')
            . " WHERE 1 {$condition} and status=3", $params);
