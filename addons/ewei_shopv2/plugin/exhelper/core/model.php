...
class ExhelperModel extends PluginModel 
{
	...
	{
		load()->func('communication');
		$resp = ihttp_post('http://api.avatardata.cn/PostNumber/QueryAddress', array('key' => '8616561535da4ccc8042ebe32acb86dc', 'address' => trim($Address), 'rows' => 1));
		$ret = @json_decode($resp['content'], true);
		if ($ret['error_code'] == 0) 
		{
			return $ret['result'][0]['postnumber'];
		}
		return false;
	}
}
