...
class Single_EweiShopV2Page extends PluginWebPage {
    ...
    function getorder(){
        ...
        if($_W['ispost']){
            ...
            $sql = "select distinct o.* , a.realname,a.mobile,a.province,a.city,a.area, d.dispatchname,m.nickname,r.status as refundstatus from " . tablename('ewei_shop_order') . " o"
