    ...
    public function rule() {
        ...
        if ($_W['ispost']){
            ...
            $data = array(
                ...
                'signold'=>intval($_GPC['signold']),
                'signold_price'=>intval($_GPC['signold_price']),
                'signold_type'=>intval($_GPC['signold_type']),
                'textsign'=>trim($_GPC['textsign']),
                'textsignold'=>trim($_GPC['textsignold']),
                'textsigned'=>trim($_GPC['textsigned']),
                'textsignforget'=>trim($_GPC['textsignforget']),
                'maincolor'=>trim($_GPC['maincolor']),
                'cycle'=>intval($_GPC['cycle']),
                'reward_default_first'=>intval($_GPC['reward_default_first']),
                'reward_default_day'=>intval($_GPC['reward_default_day']),
                'reword_order'=>$_GPC['reword_order'],
                'reword_sum'=>$_GPC['reword_sum'],
                'reword_special'=>$_GPC['reword_special'],
                'sign_rule'=>iserializer($_GPC['sign_rule']),
            );
    ...
    public function set() {
        ...
        if($_W['ispost']){
            ...
            $data = array(
                ...
                'iscreditshop'=>intval($_GPC['iscreditshop']),
                'keyword'=>trim($_GPC['keyword']),
