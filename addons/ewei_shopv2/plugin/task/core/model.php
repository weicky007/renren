...
class TaskModel extends PluginModel
{
    ...
    public function pickTask($taskid, $openid)
    {
        ...
        $taskArr = array(
            ...
            'member_group' => $task['member_group'],
            'auto_pick' => $task['auto_pick'],
        );
    ...
    protected function checkCanPick($task, $openid)
    {
        ...
        if ($task_start > $time) {
            ...
            if ($finishtime < 0 && ($stoptime > $time || $stoptime < 0)) {
    ...
    public function taskPickMessage($openid, $record)
    {
        ...
        m('notice')
            ->sendNotice(array(
                ...
                'default' => $message,
                'cusdefault' => $text,
                'url' => empty($notice_data['task_pick_template'])?$url:'',
                'datas' => $datas,
            ));
    }
    ...
    public function taskProgressMessage($openid, $record)
    {
        ...
        m('notice')
            ->sendNotice(array(
                ...
                'default' => $message,
                'cusdefault' => $text,
                'url' => empty($notice_data['task_progress_template'])?$url:'',
                'datas' => $datas,
            ));
    }
    ...
    public function taskFinishMessage($openid, $record)
    {
        ...
        m('notice')
            ->sendNotice(array(
                ...
                'default' => $message,
                'cusdefault' => $text,
                'url' => empty($notice_data['task_finish_template'])?$url:'',
                'datas' => $datas,
            ));
    }
    ...
    public function posterPickMessage($openid, $record)
    {
        ...
        m('notice')
            ->sendNotice(array(
                ...
                'default' => $message,
                'cusdefault' => $text,
                'url' => empty($notice_data['task_poster_pick_template'])?$url:'',
                'datas' => $datas,
            ));
    }
    ...
    public function posterProgressMessage($openid, $record)
    {
        ...
        m('notice')->sendNotice(array(
            ...
            'default' => $message,
            'cusdefault' => $text,
            'url' => empty($notice_data['task_poster_progress_template'])?$url:'',
            'datas' => $datas,
        ));
    }
    ...
    public function posterFinishMessage($openid, $record)
    {
        ...
        m('notice')
            ->sendNotice(array(
                ...
                'default' => $message,
                'cusdefault' => $text,
                'url' => empty($notice_data['task_poster_finish_template'])?$url:'',
                'datas' => $datas,
            ));
    }
    ...
    public function taskPosterFollowMessage($openid, $record, $nickname = '')
    {
        ...
        m('notice')
            ->sendNotice(array(
                ...
                'default' => $message,
                'cusdefault' => $text,
                'url' => empty($notice_data['task_poster_scan_template'])?$url:'',
                'datas' => $datas,
            ));
    }
