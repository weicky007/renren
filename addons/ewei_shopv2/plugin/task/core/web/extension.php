...
class Extension_EweiShopV2Page extends PluginWebPage 
{
	...
	public function __construct() 
	{
		...
		switch ($this->action) 
		{
			case 'single': $this->taskType = '单次任务';
			break;
			case 'repeat': $this->taskType = '重复任务';
			break;
			case 'first': $this->taskType = '新手任务';
			break;
			case 'period': $this->taskType = '周期任务';
			break;
			case 'point': $this->taskType = '目标任务';
			break;
			default: exit('不存在的任务类型');
		}
	...
	public function add() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			switch ($this->action) 
			{
				case 'single': $data['type'] = 1;
				break;
				case 'repeat': $data['type'] = 2;
				break;
				case 'first': $data['type'] = 3;
				break;
				case 'period': $data['type'] = 4;
				break;
				case 'point': $data['type'] = 5;
				break;
				default: show_json(0, '不存在的类型');
			}
