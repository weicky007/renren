...
class User_EweiShopV2Page extends PluginWebPage
{
    ...
    protected function post()
    {
        ...
        if ($id){
            ...
            $wechatpay2 = json_decode($item['wechatpay'], true);
            if ($item['set']){
        ...
        if ($_W['ispost']) {
            ...
            if (!empty($item)){
                ...
                $userset['credit1_double'] = empty($_GPC['credit1_double']) ? 1 : (float)$_GPC['credit1_double'];
            }
            ...
            $params = array(
                ...
                'setmeal'=>$_GPC['setmeal'],
                'title'=>$_GPC['title'],
                'logo'=>$_GPC['logo'],
                'manageopenid'=>$_GPC['manageopenid'],
                'isopen_commission'=>$_GPC['isopen_commission'],
                'openid'=>$_GPC['openid'],
                'name'=>$_GPC['name'],
                'mobile'=>$_GPC['mobile'],
                ...
                'wechatpay'=>$wechatpay,
                'alipay_status'=>$_GPC['alipay_status'],
                'alipay'=>$alipay,
                'withdraw'=>$_GPC['withdraw'],
                'username'=>$_GPC['username'],
                'password'=>!empty($_GPC['password'])?$_GPC['password']:'',
                'status'=>$_GPC['status'],
                'lifetimestart'=>strtotime($lifetime['start']),
                'lifetimeend'=>strtotime($lifetime['end']),
                'set'=>json_encode($userset),
                'can_withdraw'=>intval($_GPC['can_withdraw']),
                'show_paytype'=>intval($_GPC['show_paytype']),
                'couponid'=>is_array($_GPC['couponid']) ? implode(',',$_GPC['couponid']) : '',
                'management'=>is_array($_GPC['management']) ? implode(',',$_GPC['management']) : '',
                'notice_openids'=>is_array($_GPC['notice_openids']) ? implode(',',$_GPC['notice_openids']) : '',
            );
