...
class AppMobilePage extends PluginMobilePage
{
    ...
    public function __construct()
    {
        ...
        empty($global_set["trade"]["credittext"]) && $global_set["trade"]["credittext"];
        empty($global_set["trade"]["moneytext"]) and $global_set["trade"]["moneytext"] = "余额";
        empty($global_set["trade"]["moneytext"]) && $global_set["trade"]["moneytext"];
...
function app_json($result = NULL)
{
    ...
    $ret["sysset"] = array("shopname" => $_W["shopset"]["shop"]["name"], "shoplogo" => $_W["shopset"]["shop"]["logo"], "description" => $_W["shopset"]["shop"]["description"], "saleout_icon" => isset($_W["shopset"]["shop"]["saleout"]) ? tomedia($_W["shopset"]["shop"]["saleout"]) : "", "trade" => $_W["shopset"]["trade"]["istimetext"], "share" => $_W["shopset"]["share"], "texts" => array("credit" => $_W["shopset"]["trade"]["credittext"], "money" => $_W["shopset"]["trade"]["moneytext"]), "isclose" => $_W["shopset"]["app"]["isclose"], "force_auth" => isset($_W["shopset"]["app"]["force_auth"]) ? $_W["shopset"]["app"]["force_auth"] : 0);
