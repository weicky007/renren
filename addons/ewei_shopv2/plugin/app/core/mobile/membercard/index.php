...
class Index_EweiShopV2Page extends AppMobilePage
{
    ...
    public function getlist()
    {
        ...
        if ($cate == 'my') {
            $all = $plugin_membercard->get_Mycard($openid,$_GPC['page'], 20, 'all');
            $list = $all['list'];
            $psize = $all['psize'];
            $total = $all['total'];
        ...
        return app_json(array('list' => $list,'cate' => $cate,'pagesize' => $psize, 'total' => $total,'my_total'=>$my_total,'all_total'=>$all_total));
    }
