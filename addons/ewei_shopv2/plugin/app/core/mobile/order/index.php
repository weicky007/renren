...
class Index_EweiShopV2Page extends AppMobilePage
{
	...
	public function detail()
	{
		...
		$result = array('order' => $order, 'goods' => $allgoods, 'address' => $address, 'express' => $express, 'carrier' => $carrier, 'store' => $store, 'stores' => $stores, 'shop' => $shop, 'customer' => intval($_W['shopset']['app']['customer']));
