...
class Goods_EweiShopV2Page extends AppMobilePage
{
    ...
    public function get_detail()
    {
        ...
        if ($goods["isdiscount"] && time() <= $goods["isdiscount_time"] && $goods["isdiscount_time_start"] < time()) {
        ...
        $goods["memberprice"] = "";
        if ((empty($goods["isdiscount"]) || $goods["isdiscount_time"] < time() || time() < $goods["isdiscount_time_start"]) && !empty($memberprice) && $memberprice != $goods["minprice"] && !empty($level)) {
            ...
            if (is_array($discounts)) {
                ...
                if (!isset($discounts["type"]) || empty($discounts["type"])) {
                    ...
                    if (!empty($discounts[$key])) {
                        ...
                        if (0 < $dd && $dd < 10) {
                            $memberprice_dis = round($dd / 10 * $minprice, 2);
                        }
                    } else {
                        ...
                        if (!empty($dd)) {
                            ...
                            if (0 < $md && $md < 10) {
                                $memberprice_dis = round($md / 10 * $minprice, 2);
                            } else {
                                if (!empty($set["shop"]["leveldiscount"])) {
