...
class Goods_EweiShopV2Page extends AppMobileAuthPage
{
    ...
    {
        return app_json(array("perm" => array("goods_add" => cv("goods.add"), "goods_view" => cv("goods.view"), "goods_edit" => cv("goods.edit"), "goods_status" => cv("goods.status"), "goods_delete" => cv("goods.delete"), "goods_restore" => cv("goods.restore"), "goods_stock" => cv("goods.stock"))));
    }
    /**
     * 获取商品列表
     */
    public function get_list()
    {
        ...
        empty($goodsfrom) and $_GPC["status"] = $goodsfrom = "sale";
        if ($goodsfrom == "sale") {
