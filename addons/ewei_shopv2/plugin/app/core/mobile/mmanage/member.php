...
class Member_EweiShopV2Page extends AppMobileAuthPage
{
    ...
    {
        return app_json(array( "perm" => array( "member" => cv("member") ) ));
    }
    ...
    public function get_list()
    {
        ...
        return app_json(array( "total" => $total, "list" => $listArr, "pagesize" => $psize, "page" => $pindex, "perm" => array( "member_view" => cv("member.list.view"), "member_edit" => cv("member.list.edit") ) ));
    }
