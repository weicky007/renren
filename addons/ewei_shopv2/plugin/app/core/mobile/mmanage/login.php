...
class Login_EweiShopV2Page extends AppMobilePage
{
    ...
    public function submit()
    {
        ...
        else
        {
            ...
            if( !in_array($account["uid"], $founders) && $account["status"] != 2 ) 
            {
        ...
        return app_json(array( "account" => array( "uid" => $account["uid"], "uniacid" => (is_array($roleuser) ? $roleuser["uniacid"] : 0), "username" => $account["username"], "admin" => $admin ) ));
    }
