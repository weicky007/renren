...
class Index_EweiShopV2Page extends AppMobileAuthPage {
    ...
    public function home() {
        ...
        $result = array(
            'shopset'=>array(
                'name'=>$_W['shopset']['shop']['name'],
                'logo'=>tomedia($_W['shopset']['shop']['logo']),
            ...
            'perms'=>array(
                'sysset'=>cv('sysset'),
                'order_status0'=>cv('order.list.status0'),
                'order_status1'=>cv('order.list.status1'),
                'order_status2'=>cv('order.list.status2'),
                'order_status4'=>cv('order.list.status4'),
                'order_status5'=>cv('order.list.status5'),
                'goods'=>cv('goods'),
                'member'=>cv('member'),
                'finance'=>cv('finance'),
