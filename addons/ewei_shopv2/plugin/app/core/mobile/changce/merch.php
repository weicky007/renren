...
class Merch_EweiShopV2Page extends AppMobilePage
{
    ...
    public function goods_list()
    {
        ...
        if (!empty($_GPC['isrecommand'])) {
            $args['isrecommand'] = $_GPC['isrecommand'];
        }
        if (!empty($_GPC['isnew'])) {
            $args['isnew'] = $_GPC['isnew'];
        }
    ...
    public function get_detail()
    {
        ...
        if ($merch_plugin && $merch_data['is_openmerch']) {
            ...
            if (file_exists('../addons/ewei_shopv2/storebg.png')) {
                $merch['storebg'] = $_W['siteroot'] . '/addons/ewei_shopv2/storebg.png';
            } elseif (!empty($merch_data['regbg'])) {
                $merch['storebg'] = tomedia($merch_data['regbg']);
            } else {
                $merch_data['regbg'] = '';
            }
        } else {
