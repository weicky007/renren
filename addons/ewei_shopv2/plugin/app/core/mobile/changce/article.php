...
class Article_EweiShopV2Page extends AppMobilePage
{
    ...
    public function get_detail()
    {
        ...
        if (empty($article['phone']) && intval($_W['shopset']['app']['phone']) && !empty($_W['shopset']['app']['phonenumber'])) {
            $article['phone'] = $_W['shopset']['app']['phonenumber'];
        }
        if (!empty($article['phone'])) {
            $article['phonecolor'] = empty($_W['shopset']['app']['phonecolor']) ? '#ff5555' : $_W['shopset']['app']['phonecolor'];
        }
