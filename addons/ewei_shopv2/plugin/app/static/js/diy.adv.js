define(['jquery.ui'], function (ui) {
    ...
    modal.init = function (params) {
        ...
        if (!modal.advs) {
            modal.advs = {
                ...
                data: {
                    M0123456789101: {
                        imgurl: '../addons/ewei_shopv2/plugin/app/static/images/default/adv-1.jpg',
                        linkurl: '',
                        click: '0'
                    },
                    M0123456789102: {
                        imgurl: '../addons/ewei_shopv2/plugin/app/static/images/default/adv-2.jpg',
                        linkurl: '',
                        click: '0'
                    },
                    M0123456789103: {
                        imgurl: '../addons/ewei_shopv2/plugin/app/static/images/default/adv-3.jpg',
                        linkurl: '',
                        click: '0'
                    }
                }
        ...
        modal.advs.params.style = 'small-bot';
        modal.advs.style.opacity = '0.6';
    ...
    modal.save = function () {
        ...
        if (modal.id) {
            var posturl = biz.url("app/startadv/edit", null, modal.merch)
        } else {
            var posturl = biz.url("app/startadv/add", null, modal.merch)
        }
