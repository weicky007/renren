    ...
    modal.initNotice = function () {
        ...
        if($(".fui-topmenu").length > 0){
            $(".topmenu_tab").each(function(index,item){
                ...
                var touming = $(this).data('touming');
                if(index == 0){
                    if(touming){
                        $(this).css({'background-color':"rgba(241, 241, 242, 0)",'border-color':activecolor,'color':activecolor});
                    }else{
                    ...
                    if(touming){
                        $(this).css({'background-color':"rgba(241, 241, 242, 0)",'border-color':"#fff",'color':textcolor});
                    }else{
        ...
        if($(".fui-tabbar").length > 0){
            $('.tabbar-num').each(function(indexs,items){
                ...
                $this.find('.tab-a').each(function(index,items){
                    ...
                    if(index == modal.tabbar_index){
                        if(touming){
                            $(this).css({'background-color':"rgba(241, 241, 242, 0)",'border-color':activecolor,'color':activecolor,'border-bottom': '0px solid transparent'});
                        }else{
                            $(this).css({'background-color':activebgcolor,'border-color':activecolor,'color':activecolor});
                        }
                        ...
                        if(touming){
                            $(this).css({'background-color':"rgba(241, 241, 242, 0)",'border-color':"#fff",'color':textcolor,'border-bottom': '0px solid transparent'});
                        }else{
                            $(this).css({'background-color':bgcolor,'border-color':"#fff",'color':textcolor});
                        }
                    }
            ...
            $(document).on('click', '.tab-a', function () {
                ...
                if(touming){
                    $this.prevAll().css({'background-color':"rgba(241, 241, 242, 0)",'border-color':"#fff",'color':textcolor,'border-bottom': '0px solid transparent'}).removeClass('active');
                    $this.css({'background-color':"rgba(241, 241, 242, 0)",'border-color':activecolor,'color':activecolor,'border-bottom': '0px solid transparent'}).addClass('active');
                    $this.nextAll().css({'background-color':"rgba(241, 241, 242, 0)",'border-color':"#fff",'color':textcolor,'border-bottom': '0px solid transparent'}).removeClass('active');
                }else{
