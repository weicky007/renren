			...
			if (($message_type == TM_ABONUS_PAY) && empty($usernotice['abonus_pay'])) {
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '区域代理分红发放通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的区域代理分红已发放', 'color' => '#000000'),
			 ...
			 else if (($message_type == TM_ABONUS_UPGRADE) && empty($usernotice['abonus_upgrade'])) {
				if ($tm['is_advanced']) {
					...
					if (($data['aagenttype'] == 1) && empty($tm['abonus_upgrade1_close_advanced'])) {
					 ...
					 else if (($data['aagenttype'] == 2) && empty($tm['abonus_upgrade2_close_advanced'])) {
						$tag = 'abonus_upgrade2';
						$message = $tm['upgrade2'];
						$upgradetitle = ((empty($tm['upgradetitle2']) ? '市级代理等级升级通知' : $tm['upgradetitle2']));
					}
					 else if (($data['aagenttype'] == 3) && empty($tm['abonus_upgrade3_close_advanced'])) {
						$tag = 'abonus_upgrade3';
						$message = $tm['upgrade3'];
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '区域等级升级通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的区域代理等级从' . $data['oldlevel']['levelname'] . '升级为' . $data['newlevel']['levelname'] . '特此通知！', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
			 ...
			 else if (($message_type == TM_ABONUS_BECOME) && empty($usernotice['abonus_become'])) {
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '成为区域代理通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您已成为' . $aagenttype, 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
