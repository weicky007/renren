...
<style type="text/css">
   .page-shop-goods_category.iphonex .fui-header{
		top:0rem;
		height:3.2rem;
		padding-top:1rem
	}
	.page-shop-goods_category.iphonex .fui-header ~ .fui-content{
		top:3.2rem
	}
	.page-shop-goods_category.iphonex .fui-header .title{
		top:1rem
	}
</style>
<script>
...
<script language='javascript'>
	...
	$(function () {
        setTimeout(function () {
            ...
            //  微信版本6.6.7
            if(h == 1923){
                $(".fui-page").removeClass('iphonex');
                return;
            }

            if(height==2436 && width==1125){
                $(".fui-page").addClass('iphonex')
            }
        },600)
    })
</script>
