...
<head>
    ...
    <style>
        ...
        <?php  if(is_ios()) { ?>.head-menu-mask, .fui-mask, .fui-mask-m, .order-list-page .fui-tab {top: 2rem;}.head-menu{top: 3.65rem}<?php  } ?>
    </style>
    <?php  } ?>
...
<div class='fui-page-group <?php  if(is_ios() && !is_h5app()) { ?>statusbar<?php  } ?>'>
    <?php  if(is_h5app()) { ?>
