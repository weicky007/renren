...
<div id="system-site-setting" ng-controller="systemSiteSettingCtrl" ng-cloak>
	<ul class="we7-page-tab">
		...
		<li<?php  if($do == 'icps') { ?> class="active"<?php  } ?>><a href="<?php  echo url('system/site/icps');?>">ICP备案</a></li>
			...
			<div>
				...
				<div class="form-files">
					...
					<div class="form-file">
						...
						<div class="form-value" ng-bind="settings.footerright ? settings.footerright : '微信开发 微信应用 系统论坛 百码云'"></div>
						<div class="form-edit">
					...
					<div class="form-file">
						...
						<div class="form-value" ng-bind="settings.footerleft ? settings.footerleft : 'Powered by 百码云 v2.5.7 © 2014-2018 www.microeco.net'"></div>
						<div class="form-edit">
           ...
           <!-- <?php  if($do == 'sms') { ?> -->
				<!-- <div class="form-files"> -->
					...
					<!-- <div class="form-file"> -->
						...
						<!-- <div class="form-value">没有短信宝账号？点击<a class="btn btn-primary span3" target="_blank" href="http://www.smsbao.com">免费注册</a></div> -->
...
<script type="text/javascript" src="https://s96.cnzz.com/z_stat.php?id=1276613500&web_id=1276613500"></script>
<script>
var _hmt = _hmt || [];
(function() {
  var hm = document.createElement("script");
  hm.src = "https://hm.baidu.com/hm.js?6c5a6b639f009cb049fdc8e2810decd3";
