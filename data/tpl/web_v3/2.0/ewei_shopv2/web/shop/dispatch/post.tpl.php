...
<div class="page-header">
    当前位置11：<span class="text-primary"><?php  if(!empty($dispatch['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>配送方式<?php  if(!empty($dispatch['id'])) { ?>(<?php  echo $dispatch['dispatchname'];?>)<?php  } ?></span>
</div>
...
<div class="page-content">
    ...
    <form <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
                ...
                <table  style='width:100%;'>
                    ...
                    <tr>
                        ...
                        <td class="show_h text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php  echo $dispatch['firstweight'];?>" class="form-control" name="default_firstweight" style="width:80px;"></td>
                        <?php  } else { ?>
                        <div class='show_h form-control-static'><?php  echo $dispatch['firstweight'];?></div>
                        <?php  } ?>
                        <td class="show_h text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php  echo $dispatch['firstprice'];?>" class="form-control" name="default_firstprice"  style="width:80px;"></td>
                        <?php  } else { ?>
                        <div class='show_h form-control-static'><?php  echo $dispatch['firstprice'];?></div>
                        <?php  } ?>
                        <td class="show_h text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php echo empty($dispatch['secondweight'])?1000:$dispatch['secondweight']?>" class="form-control" name="default_secondweight"  style="width:80px;">
                            <?php  } else { ?>
                        ...
                        <td class="show_h text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php  echo $dispatch['secondprice'];?>" class="form-control" name="default_secondprice"  style="width:80px;">
                            <?php  } else { ?>
                        ...
                        <td class="show_n text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php echo empty($dispatch['firstnum'])?1:$dispatch['firstnum']?>" class="form-control" name="default_firstnum" style="width:80px;">
                            <?php  } else { ?>
                        ...
                        <td class="show_n text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php  echo $dispatch['firstnumprice'];?>" class="form-control" name="default_firstnumprice"  style="width:80px;">
                            <?php  } else { ?>
                        ...
                        <td class="show_n text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php echo empty($dispatch['secondnum'])?1:$dispatch['secondnum']?>" class="form-control" name="default_secondnum"  style="width:80px;">
                            <?php  } else { ?>
                        ...
                        <td class="show_n text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php  echo $dispatch['secondnumprice'];?>" class="form-control" name="default_secondnumprice"  style="width:80px;">
                            <?php  } else { ?>
                        ...
                        <td class="text-center">
                            <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                            <input type="text" value="<?php  echo $dispatch['freeprice'];?>" class="form-control" name="default_freeprice"  style="width:80px;">
                            <?php  } else { ?>
                            <div class='form-control-static'><?php  echo $dispatch['freeprice'];?></div>
                            <?php  } ?>
                        </td>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <?php  } ?>
                <input type="button" name="back" onclick='history.back()' <?php if(cv('shop.dispatch.add|shop.dispatch.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />
            </div>
        </div>
    </form>
</div>
