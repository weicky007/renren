	...
	<div class="region-goods-right col-sm-10">
		...
		<div class="form-group" >
			...
			<div class="col-sm-8 col-xs-12">
				...
				<label class="radio-inline"><input type="radio" name="verify_type1" value="0" <?php  if(empty($item['verifytype']) ) { ?>checked="true"<?php  } ?>  /> 按订单核销</label>
				<label class="radio-inline"><input type="radio" name="verify_type1" value="2" <?php  if($item['verifytype'] == 2) { ?>checked="true"<?php  } ?>   /> 按核销次数核销</label>
				<div class="help-block">按订单核销:  核销一次后即过期,填写的核销次数作废</div>
				<div class="help-block">按核销次数核销:  按设置的单个商品核销次数核销 </div>
				<?php  } ?>
			</div>
		</div>
		<div class="form-group" >
