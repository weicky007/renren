<?php defined('IN_IA') or exit('Access Denied');?><div class="region-goods-details row">
    ...
    <div class="region-goods-right col-sm-10">
        ...
        <div class="col-sm-4 col-xs-6">
            <?php echo tpl_form_field_eweishop_daterange('saletime', array('starttime'=>date('Y-m-d H:i', !empty($item['timestart'])?$item['timestart']:time()),'endtime'=>date('Y-m-d H:i', !empty($item['timeend'])?$item['timeend']:strtotime('7 days'))),true);?>
        </div>
        <?php  } else { ?>
    ...
    <div id="isdiscount_time" class="form-group" <?php  if($item['isdiscount']!=1) { ?>style="display:none"<?php  } ?>>
        ...
        <?php if( ce('goods' ,$item) ) { ?>
        <div class="col-sm-4 col-xs-6">
            <?php  $time = array('start'=>$item['isdiscount_time_start'],'end'=>$item['isdiscount_time']);?>
    ...
    <div class="region-goods-right col-sm-10">
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <p class="help-block">
                    会员购物赠送的积分, 如果不填写，则默认为不赠送积分，会走营销中赠送规则
                </p>
                <p class="help-block">
                    如果填写0,则该商品不赠送积分,也不会走营销中的赠送规则,如果带%则为按成交价格的比例计算积分
                </p>
                <p class="help-block">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <label class="checkbox-inline" for="manydeduct2">
                    <input id="manydeduct2" type="checkbox" <?php  if($item['manydeduct2']==1 ) { ?>checked="true"<?php  } ?> value="1" name="manydeduct2">
                    允许多件累计抵扣
                </label>
                        <span class="help-block">
                ...
                <?php  } else { ?>
                <div class='form-control-static'>
                    <?php  if(empty($item['deduct2'])) { ?> 支持全额抵扣 <?php  } else if($item['deduct2']==-1) { ?> 不支持余额抵扣<?php  } else { ?> 最多抵扣 <?php  echo $item['deduct2'];?> 元 <?php  } ?><?php  if(empty($item['manydeduct2'])) { ?>不允许多件累计抵扣<?php  } else { ?>允许多件累计抵扣 <?php  } ?>
                </div>
                <?php  } ?>
            </div>
        </div>
